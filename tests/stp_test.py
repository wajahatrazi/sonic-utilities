...
class TestStp(object):
    ...
    def test_stp_validate_interface_params(self):
        ...
        result = runner.invoke(config.config.commands["spanning-tree"].commands["interface"].commands["portfast"].commands["disable"], ["Ethernet4"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code == 0

        result = runner.invoke(config.config.commands["spanning-tree"].commands["interface"].commands["portfast"].commands["enable"], ["Ethernet4"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code == 0

        result = runner.invoke(config.config.commands["spanning-tree"].commands["interface"].commands["uplink_fast"].commands["disable"], ["Ethernet4"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code == 0

        result = runner.invoke(config.config.commands["spanning-tree"].commands["interface"].commands["uplink_fast"].commands["enable"], ["Ethernet4"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code == 0
        ...
        result = runner.invoke(config.config.commands["spanning-tree"].commands["interface"].commands["bpdu_guard"].commands["disable"], ["Ethernet4"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code == 0

        result = runner.invoke(config.config.commands["spanning-tree"].commands["interface"].commands["bpdu_guard"].commands["enable"], ["Ethernet4", "--shutdown"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code == 0
        ...
        result = runner.invoke(config.config.commands["spanning-tree"].commands["interface"].commands["root_guard"].commands["enable"], ["Ethernet4"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code == 0
        ...
        result = runner.invoke(config.config.commands["spanning-tree"].commands["interface"].commands["enable"], ["Ethernet120"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code != 0
        assert "is a portchannel member port" in result.output

        result = runner.invoke(config.config.commands["spanning-tree"].commands["interface"].commands["enable"], ["Ethernet20"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code != 0
    ...
    def test_stp_validate_vlan_interface_params(self):
        ...
        result = runner.invoke(config.config.commands["spanning-tree"].commands["vlan"].commands["interface"].commands["cost"], ["100", "Ethernet4", "0"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code != 0
        assert "STP interface path cost must be in range 1-200000000" in result.output
        ...
        result = runner.invoke(config.config.commands["spanning-tree"].commands["vlan"].commands["interface"].commands["priority"], ["100", "Ethernet4", "1000"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code != 0
        ...
        result = runner.invoke(config.config.commands["spanning-tree"].commands["vlan"].commands["interface"].commands["priority"], ["101", "Ethernet4", "16"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code != 0
    ...
    def test_stp_validate_vlan_timer_and_priority_params(self):
        ...
        result = runner.invoke(config.config.commands["spanning-tree"].commands["vlan"].commands["hello"], ["100", "3"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code == 0

        result = runner.invoke(config.config.commands["spanning-tree"].commands["vlan"].commands["max_age"], ["100", "21"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code == 0

        result = runner.invoke(config.config.commands["spanning-tree"].commands["vlan"].commands["forward_delay"], ["100", "16"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code == 0
        ...
        result = runner.invoke(config.config.commands["spanning-tree"].commands["vlan"].commands["hello"], ["100", "0"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code != 0
        assert "STP hello timer must be in range 1-10" in result.output

        result = runner.invoke(config.config.commands["spanning-tree"].commands["vlan"].commands["hello"], ["100", "20"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code != 0
        assert "STP hello timer must be in range 1-10" in result.output

        result = runner.invoke(config.config.commands["spanning-tree"].commands["vlan"].commands["forward_delay"], ["100", "2"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code != 0
        ...
        result = runner.invoke(config.config.commands["spanning-tree"].commands["vlan"].commands["priority"], ["100", "70000"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code != 0
    ...
    def test_add_vlan_enable_pvst(self):
        ...
        result = runner.invoke(config.config.commands["spanning-tree"].commands["vlan"].commands["disable"], ["200"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code == 0
        ...
        result = runner.invoke(config.config.commands["spanning-tree"].commands["vlan"].commands["enable"], ["101"], obj=db)
        print("exit code {}".format(result.exit_code))
        print("result code {}".format(result.output))
        assert result.exit_code != 0
